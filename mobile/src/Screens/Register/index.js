  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      >
        ...
        >
          <Text style={{ fontFamily: 'OpenSans-Bold', fontSize: RFValue(18) }}>Select a dropping point</Text>
          <Pressable
        ...
        <DistrictList onPress={(district) => setState({ ...state, isVisible: false, district })} />
      </BottomSheet>
      {state.checkCode ? (
        <CheckCode
          code={state.code}
